            ...
            <div className="intro-slider-container mb-0">
                <div className="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl"
                    ...
                    <div className="intro-slide"
                         style={{backgroundImage:"url(assets/images/demos/demo-5/slider/slide-1.jpg)",height:"610px"}}>
                    ...
                    <div className="intro-slide"
                         style={{backgroundImage:"url(assets/images/demos/demo-5/slider/slide-2.jpg)",height:"610px"}}>
                        <div className="container intro-content text-center">
                        ...
                        <div className="col-md-6">
                            ...
                            <div className="banner banner-border-hover">
                                ...
                                <div className="banner-content">
                                    ...
                                    <h3 className="banner-title"><a href="#"><span>Womens <br/>Holiday Clothes</span></a>
                                    </h3>
                                    <a href="#" className="btn btn-outline-primary-2 banner-link">Discover Now<i
                                        className="icon-long-arrow-right"></i></a>
                                </div>
                                                ...
                                                <div className="products">
                                                    <div className="col-6">
                                                        <div className="product product-2 text-center">
                                                            ...
                                                            <div className="product-body">
                                                                <h3 className="product-title"><a href="product.html">Rib-knit
                                                                    cardigan</a></h3>
                                                                <div className="product-price">
                                                                    $24.99
                                                                </div>
                                ...
                                <div className="col-6 col-md-4 col-lg-3">
                                    <div className="product product-2">
                                        ...
                                        <div className="product-body">
                                            ...
                                            <h3 className="product-title"><a href="product.html">Linen-blend dress</a>
                                            </h3>
                                            <div className="product-price">
                                                $60.00
                                            </div>
                                            <div className="product-nav product-nav-dots">
                                                <a href="#" className="active" style={{background:"#e5dcb1"}}><span
                                                    className="sr-only">Color name</span></a>
                                                <a href="#" style={{background:"#b9cbd8"}}><span className="sr-only">Color name</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="col-6 col-md-4 col-lg-3">
                                    <div className="product product-2">
                                        ...
                                        <div className="product-body">
                                            ...
                                            <h3 className="product-title"><a href="product.html">Sandals with lacing</a>
                                            </h3>
                                            <div className="product-price">
                                ...
                                <div className="col-6 col-md-4 col-lg-3">
                                    <div className="product product-2">
                                        ...
                                        <div className="product-body">
                                            ...
                                            <h3 className="product-title"><a href="product.html">Paper bag trousers</a>
                                            </h3>
                                            <div className="product-price">
                                                $60.00
                                            </div>
                                ...
                                <div className="col-6 col-md-4 col-lg-3">
                                    <div className="product product-2">
                                        ...
                                        <div className="product-body">
                                            ...
                                            <h3 className="product-title"><a href="product.html">Paper straw shopper</a>
                                            </h3>
                                            <div className="product-price">
                                                $398.00
                                            </div>
